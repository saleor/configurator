...
version: 1.0.0
description: "Parsing JSON envelope output from Configurator CLI commands. MUST be loaded before any agent parses CLI JSON output. Use whenever processing exit codes, JSON envelopes, drill-down workflows, or building automation around the CLI."
allowed-tools: Bash, Read
license: MIT
compatibility: "Claude Code or Claude.ai. Requires @saleor/configurator CLI."
---

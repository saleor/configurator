...
describe("E2E Selective Operations Safety Tests", () => {
  ...
  describe("Include Operations Safety", () => {
    it("should ONLY modify included sections and NEVER touch others", async () => {
      ...
      const originalChannel = afterShopState.channels?.find((c: any) => c.slug === "original-channel");
      expect(originalChannel.name).toBe("Original Channel"); // NOT modified
      
      const secondChannel = afterShopState.channels?.find((c: any) => c.slug === "second-channel");
      ...
      const originalCategory = afterShopState.categories?.find((c: any) => c.slug === "original-category");
  ...
  describe("Exclude Operations Safety", () => {
    it("should NEVER modify excluded sections even when config differs", async () => {
      ...
      const criticalChannel = afterExcludeState.channels?.find((c: any) => c.slug === "critical-channel");
      ...
      const safeCategory = afterExcludeState.categories?.find((c: any) => c.slug === "safe-category");
    ...
    it("should handle exclude with CREATE operations safely", async () => {
      ...
      const excludedChannel = state.channels?.find((c: any) => c.slug === "excluded-new-channel");
      expect(excludedChannel).toBeUndefined();
      
      // Category should exist (not excluded)
      const allowedCategory = state.categories?.find((c: any) => c.slug === "allowed-new-category");
  ...
  describe("Complex Selective Scenarios", () => {
    it("should safely handle complex include/exclude combinations", async () => {
      ...
      const categoryA = complexResult.categories?.find((c: any) => c.slug === "category-a");
      expect(categoryA.name).toBe("MODIFIED Category A");
      expect(categoryA.description).toBe("MODIFIED Category A description");
      
      const categoryC = complexResult.categories?.find((c: any) => c.slug === "category-c");
      expect(categoryC.name).toBe("MODIFIED Category C");
      
      const categoryD = complexResult.categories?.find((c: any) => c.slug === "category-d");
      ...
      const primaryChannel = complexResult.channels?.find((c: any) => c.slug === "primary-channel");
      expect(primaryChannel.name).toBe("Primary Channel"); // NOT modified
      
      const secondaryChannel = complexResult.channels?.find((c: any) => c.slug === "secondary-channel");
    ...
    it("should prevent accidental data loss with selective operations", async () => {
      ...
      const productionChannel = protectedResult.channels?.find((c: any) => c.slug === "production-channel");
      ...
      const criticalCategory = protectedResult.categories?.find((c: any) => c.slug === "critical-category");

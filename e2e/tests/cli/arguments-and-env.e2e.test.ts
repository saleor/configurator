...
describe("E2E CLI Arguments and Environment Variables Tests", () => {
  ...
  beforeAll(async () => {
    ...
    container = new SaleorTestContainer({
      projectName: "saleor-cli-args-env-test",
    });
  ...
  describe("CLI Argument Handling", () => {
    ...
    it("should handle --include flag for selective operations", async () => {
      ...
      const shouldNotExistChannel = resultData.channels?.find((c: any) => c.slug === "should-not-be-included");
    ...
    it("should handle --exclude flag for selective operations", async () => {
      ...
      const baselineChannel = resultData.channels?.find((c: any) => c.slug === "baseline-channel");
  ...
  describe("Interactive Mode and TTY Detection", () => {
    ...
    it("should handle missing interactive requirements", async () => {
      ...
      const errorOutput = missingInteractiveResult.cleanStderr + missingInteractiveResult.cleanStdout;
